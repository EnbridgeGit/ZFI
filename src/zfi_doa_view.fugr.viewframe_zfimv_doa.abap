*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_DOA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_DOA           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_DOA_EXTRACT
TOTAL = ZFIMV_DOA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_DOA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_DOA_EXTRACT
TOTAL = ZFIMV_DOA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_DOA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA'
...
TOTAL = ZFIMV_DOA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_DOA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_DOA-UPD_FLAG NE SPACE.
