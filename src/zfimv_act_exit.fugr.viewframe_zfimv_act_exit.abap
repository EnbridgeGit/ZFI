*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_ACT_EXIT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_ACT_EXIT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_ACT_EXIT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_ACT_EXIT_EXTRACT
TOTAL = ZFIMV_ACT_EXIT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_ACT_EXIT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_ACT_EXIT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_ACT_EXIT_EXTRACT
TOTAL = ZFIMV_ACT_EXIT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_ACT_EXIT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_ACT_EXIT'
...
TOTAL = ZFIMV_ACT_EXIT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_ACT_EXIT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_ACT_EXIT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFIMV_ACT_EXIT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFIMV_ACT_EXIT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_ACT_EXIT_EXTRACT
TOTAL = ZFIMV_ACT_EXIT_TOTAL
