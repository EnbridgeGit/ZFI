* 2000/08/31 mdemeest 4.6B Restoring Lee Haire's code                UGL
************************************************************************
*                                                                      *
...
FORM scheckinfo_pruefen.
  ...
  IF reguh-rwbtr EQ 0.                 "Prüfung des Grundes für Zero Net
...
*----------------------------- UGL Change ------------------------- UGL
                                                                   "UGL
*---------------------------- INVOICE_TEXT  ---------------------- "UGL
form invoice_text.                                                 "UGL
* NOTE:  'Name is the company code + invoice doc. no + year        "UGL
  data: numlines  type i.                                          "UGL
  data:  begin of xheader.                                         "UGL
         include structure thead.                                  "UGL
  data:  end of xheader.                                           "UGL
                                                                   "UGL
  data:  begin of theader.                                         "UGL
         include structure thead.                                  "UGL
  data:  end of theader.                                           "UGL
                                                                   "UGL
  data:  begin of ilines occurs 5.                                 "UGL
         include structure tline.                                  "UGL
  data:  end of ilines.                                            "UGL
                                                                   "UGL
  data:  begin of formlines occurs 5.                              "UGL
         include structure tline.                                  "UGL
  data:  end of formlines.                                         "UGL
                                                                   "UGL
  data:  begin of tline.                                           "UGL
         include structure tline.                                  "UGL
  data:  end of tline.                                             "UGL
                                                                   "UGL
  data: xname like thead-tdname.                                   "UGL
  data: zname like thead-tdname.                                   "UGL
                                                                   "UGL
  perform concat_strings_3 using regup-zbukr regup-belnr           "UGL
                                 regup-gjahr xname.                "UGL
                                                                   "UGL
* MESSAGE ID 'ZS' type 'I' number '019' with xname.                "UGL
                                                                   "UGL
 call function 'READ_TEXT'                                         "UGL
      exporting                                                    "UGL
          id         = '0003'                                      "UGL
          language   = sy-langu                                    "UGL
*         name       =   'UGL 60000000361996'                      "UGL
          name       = xname                                       "UGL
          object     = 'BELEG'                                     "UGL
      importing                                                    "UGL
          header     = xheader                                     "UGL
      ...
      exceptions                                                   "UGL
          ...
          not_found               = 4                              "UGL
          object                  = 5                              "UGL
          reference_chec          = 6                              "UGL
          wrong_access_to_archive = 7                              "UGL
          others                  = 8.                             "UGL
  describe table ilines lines numlines.                            "UGL
  check numlines > 0.                                              "UGL
  loop at ilines.                                                  "UGL
    clear formlines.                                               "UGL
    formlines = ilines.                                            "UGL
    if ( ilines-tdformat <> space ).                               "UGL
         formlines-tdformat = 'IT'.                                "UGL
    endif.                                                         "UGL
    append formlines.                                              "UGL
  endloop.                                                         "UGL
                                                                   "UGL
  call function 'WRITE_FORM'                                       "UGL
       ...
       exceptions                                                  "UGL
           ...
           element       = 2.                                      "UGL
                                                                   "UGL
  call function 'WRITE_FORM_LINES'                                 "UGL
       exporting                                                   "UGL
           header        = theader                                 "UGL
       tables                                                      "UGL
           lines         = formlines                               "UGL
       exceptions                                                  "UGL
           ...
           window        = 5                                       "UGL
           others        = 6.                                      "UGL
endform.                          "End of INVOICE_TEXT             "UGL
                                                                   "UGL
*-----------------------------  CONCAT_STRINGS_3 ----------------  "UGL
form concat_strings_3 using str1 str2 str3 o_string.               "UGL
                                                                   "UGL
data: len1  type i,                                                "UGL
      len2  type i,                                                "UGL
      len3  type i,                                                "UGL
      tlen  type i.                                                "UGL
                                                                   "UGL
 describe field str1 length len1.                                  "UGL
 describe field str2 length len2.                                  "UGL
 describe field str3 length len3.                                  "UGL
                                                                   "UGL
 o_string = str1.                                                  "UGL
 o_string+len1 = str2.                                             "UGL
 o_string+tlen = str3.                                             "UGL
                                                                   "UGL
endform.                          "CONCAT_STRINGS_3                "UGL
*-------------------------  End of UGL Change  ------------------- "UGL
