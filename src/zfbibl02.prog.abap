...
FORM FILL_FTPOST_WITH_BBSEG_DATA USING COUNT.
  ...
  IF BBSEG-WSTKZ(1)                    NE NODATA.
    ...
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-PDUMMY_KE(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-PDUMMY_KE                   '.
    FTPOST-FVAL = BBSEG-PDUMMY_KE                  .
    APPEND FTPOST.
  ENDIF.
ENDFORM.
