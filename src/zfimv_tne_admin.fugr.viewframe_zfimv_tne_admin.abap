*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_TNE_ADMIN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_TNE_ADMIN     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_TNE_ADMIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_TNE_ADMIN_EXTRACT
TOTAL = ZFIMV_TNE_ADMIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_TNE_ADMIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_TNE_ADMIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_TNE_ADMIN_EXTRACT
TOTAL = ZFIMV_TNE_ADMIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_TNE_ADMIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_TNE_ADMIN'
...
TOTAL = ZFIMV_TNE_ADMIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_TNE_ADMIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_TNE_ADMIN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFIMV_TNE_ADMIN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFIMV_TNE_ADMIN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_TNE_ADMIN_EXTRACT
TOTAL = ZFIMV_TNE_ADMIN_TOTAL
