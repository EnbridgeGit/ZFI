*&---------------------------------------------------------------------*
*&  Include           ZFI_READ_MD_FOR_IS_TOP
*&---------------------------------------------------------------------*
TABLES: DD02L, EQUZ, EQUI, EQKT, ILOA, EQST, JEST, AUSP, PROP, MARD, EINA,MBEW,
        ADR6, EKKO, LFM1, NAST, T024, EKPO,EKET,BKPF,BSEG,T001,TJ02T, BPJA, PRTE,
        VBSEGK,BSIK,VBSEGD,BSID,COEJ,CSKS,EKKN,IHPA,KSSK,T006,T006A,T023T, PRPS,SOOD,SRGBTBREL,AFVC,
