FUNCTION zfi_doa_search_help_emp.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  TABLES
...
*"----------------------------------------------------------------------
*&---------------------------------------------------------------------*
*& Function Module    :  ZFI_DOA_SEARCH_HELP_EMP                       *
*& Author             :  Bheemesh Vaikuntam                            *
*& Creation Date      :  01-NOV-2011                                   *
*& Object ID          :  NA                                            *
*& Application Area   :  NA                                            *
*& Description        :  Search help exit FM to get all Emps           *
*&                         list along with names                       *
*&---------------------------------------------------------------------*
*----------------------------------------------------------------------*
...
*                           CHANGING SHLP CALLCONTROL.
    TYPES : BEGIN OF p_lookupkey,
              lookupkey    TYPE persno,
              lookupkeydes TYPE char40,
            END OF p_lookupkey.
    TYPES : BEGIN OF g_lookupkey,
                 lookupkey    TYPE char12,
                 lookupkeydes TYPE char40,
               END OF g_lookupkey.
    DATA: it_pernr  TYPE STANDARD TABLE OF p_lookupkey,
          it_grade  TYPE STANDARD TABLE OF g_lookupkey,
