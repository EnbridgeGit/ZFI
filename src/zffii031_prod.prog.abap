...
PARAMETERS: p_file1 like filename-fileextern obligatory default
                     '/usr/sap/interfaces/P01/IFFI056/ccnthdr.ftp',

            p_file2 like filename-fileextern obligatory default
                     '/usr/sap/interfaces/P01/IFFI056/ccntdat.ftp'.
...
* Write count to a file for historical purposes.
  ...
  concatenate '/usr/sap/interfaces/P01/IFFI056/custcnt_'
               banmonth3 banyear+2(2) '.txt' into countfile.
