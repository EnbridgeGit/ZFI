*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_VAL_BLART
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_VAL_BLART     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_VAL_BLART'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_VAL_BLART_EXTRACT
TOTAL = ZFIMV_VAL_BLART_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_VAL_BLART'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_VAL_BLART-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_VAL_BLART_EXTRACT
TOTAL = ZFIMV_VAL_BLART_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_VAL_BLART-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_VAL_BLART'
...
TOTAL = ZFIMV_VAL_BLART_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_VAL_BLART-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_VAL_BLART-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFIMV_VAL_BLART'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFIMV_VAL_BLART-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_VAL_BLART_EXTRACT
TOTAL = ZFIMV_VAL_BLART_TOTAL
