*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_REM_DAYS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_REM_DAYS      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_REM_DAYS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_REM_DAYS_EXTRACT
TOTAL = ZFIMV_REM_DAYS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_REM_DAYS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_REM_DAYS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_REM_DAYS_EXTRACT
TOTAL = ZFIMV_REM_DAYS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_REM_DAYS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_REM_DAYS'
...
TOTAL = ZFIMV_REM_DAYS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_REM_DAYS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_REM_DAYS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFIMV_REM_DAYS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFIMV_REM_DAYS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_REM_DAYS_EXTRACT
TOTAL = ZFIMV_REM_DAYS_TOTAL
