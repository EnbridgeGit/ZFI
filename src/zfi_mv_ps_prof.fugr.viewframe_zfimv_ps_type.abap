*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_PS_TYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_PS_TYPE       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_PS_TYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_PS_TYPE_EXTRACT
TOTAL = ZFIMV_PS_TYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_PS_TYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_PS_TYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_PS_TYPE_EXTRACT
TOTAL = ZFIMV_PS_TYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_PS_TYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_PS_TYPE'
...
TOTAL = ZFIMV_PS_TYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_PS_TYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_PS_TYPE-UPD_FLAG NE SPACE.
