*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_DOA_NEW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_DOA_NEW       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA_NEW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_DOA_NEW_EXTRACT
TOTAL = ZFIMV_DOA_NEW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA_NEW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_DOA_NEW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_DOA_NEW_EXTRACT
TOTAL = ZFIMV_DOA_NEW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_DOA_NEW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_DOA_NEW'
...
TOTAL = ZFIMV_DOA_NEW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_DOA_NEW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_DOA_NEW-UPD_FLAG NE SPACE.
