*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFIMV_FCALENDAR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFIMV_FCALENDAR     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFIMV_FCALENDAR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFIMV_FCALENDAR_EXTRACT
TOTAL = ZFIMV_FCALENDAR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFIMV_FCALENDAR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFIMV_FCALENDAR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_FCALENDAR_EXTRACT
TOTAL = ZFIMV_FCALENDAR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFIMV_FCALENDAR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFIMV_FCALENDAR'
...
TOTAL = ZFIMV_FCALENDAR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFIMV_FCALENDAR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFIMV_FCALENDAR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFIMV_FCALENDAR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFIMV_FCALENDAR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFIMV_FCALENDAR_EXTRACT
TOTAL = ZFIMV_FCALENDAR_TOTAL
